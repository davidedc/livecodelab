...
define(['core/animation-loop', 'core/background-painter', 'core/blend-controls', 'core/code-transformer', 'core/colour-functions', 'core/graphics-commands', 'core/lights-commands', 'core/matrix-commands', 'core/program-runner', 'core/renderer', 'core/threejs-system', 'core/time-keeper', 'sound/samplebank', 'sound/sound-system', 'bowser', 'buzz', 'lowLag', 'coffeescript', 'threejs', 'three-resize', 'Three.Detector', 'Three.Stats', 'Three.ShaderExtras', 'Three.EffectComposer', 'Three.MaskPass', 'Three.RenderPass', 'Three.SavePass', 'Three.ShaderPass'], function(AnimationLoop, BackgroundPainter, BlendControls, CodeTransformer, ColourFunctions, GraphicsCommands, LightsCommands, MatrixCommands, ProgramRunner, Renderer, ThreeJsSystem, TimeKeeper, SampleBank, SoundSystem, createBowser, buzz, lowLag, CoffeeScript, THREE, THREEx, Detector, Stats) {
  var LiveCodeLabCore;
  LiveCodeLabCore = (function() {
    function LiveCodeLabCore(paramsObject) {
      ...
      this.soundSystem = new SoundSystem(this.paramsObject.eventRouter, buzz, lowLag, createBowser(), new SampleBank(buzz));
