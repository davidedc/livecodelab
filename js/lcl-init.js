...
require(['core/colour-literals', 'core/event-router', 'core/livecodelab-core', 'core/program-loader', 'ui/url-router', 'ui/big-cursor', 'ui/text-dimming', 'ui/ui', 'editor/editor', 'autocoder/autocoder', 'codemirror', 'jquery', 'mousewheel', 'codemirror-lcl-mode'], function(ColourLiterals, EventRouter, LiveCodeLabCore, ProgramLoader, UrlRouter, BigCursor, EditorDimmer, Ui, Editor, Autocoder, CodeMirror, $) {
