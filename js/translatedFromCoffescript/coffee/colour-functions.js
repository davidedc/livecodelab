...
var createColourFunctions;

createColourFunctions = function() {
  "use strict";

  var ColourFunctions, Constants, color$1, color$2, color$4, colorModeX, colorModeY, colorModeZ, curColorMode, modes, modesFunction;
  ColourFunctions = {};
  Constants = void 0;
  colorModeX = 255;
  colorModeY = 255;
  ...
  color$4 = function(aValue1, aValue2, aValue3, aValue4) {
    var a, b, g, r, rgb;
    r = void 0;
    g = void 0;
    b = void 0;
  ...
  color$2 = function(aValue1, aValue2) {
    var a, angleColor;
    a = void 0;
    angleColor = -16777217;
  ...
  */
  ...
  ColourFunctions.color = function(aValue1, aValue2, aValue3, aValue4) {
  ...
  ColourFunctions.color.toString = function(colorInt) {
  ...
  ColourFunctions.color.toInt = function(r, g, b, a) {
    return (a << 24) & Constants.ALPHA_MASK | (r << 16) & Constants.RED_MASK | (g << 8) & Constants.GREEN_MASK | b & Constants.BLUE_MASK;
  };
  ColourFunctions.color.toArray = function(colorInt) {
  ...
  ColourFunctions.color.toGLArray = function(colorInt) {
  ...
  ColourFunctions.color.toRGB = function(h, s, b) {
    var br, f, hue, p, q, t;
    br = void 0;
    hue = void 0;
    f = void 0;
  ...
  window.colorToHSB = ColourFunctions.colorToHSB = function(colorInt) {
  ...
  */
  ...
  window.brightness = ColourFunctions.brightness = function(colInt) {
    return ColourFunctions.colorToHSB(colInt)[2];
  };
  /*
  ...
  */
  ...
  window.saturation = ColourFunctions.saturation = function(colInt) {
    return ColourFunctions.colorToHSB(colInt)[1];
  };
  /*
  ...
  */
  ...
  window.hue = ColourFunctions.hue = function(colInt) {
    return ColourFunctions.colorToHSB(colInt)[0];
  };
  /*
  ...
  */
  ...
  window.redF = ColourFunctions.redF = function(aColor) {
  ...
  */
  ...
  window.greenF = ColourFunctions.greenF = function(aColor) {
  ...
  */
  ...
  window.blueF = ColourFunctions.blueF = function(aColor) {
  ...
  */
  ...
  window.lerp = ColourFunctions.lerp = function(value1, value2, amt) {
  ...
  */
  ...
  window.lerpColor = ColourFunctions.lerpColor = function(c1, c2, amt) {
  ...
  */
  ...
  window.colorMode = ColourFunctions.colorMode = function(mode, range1, range2, range3, range4) {
    curColorMode = mode;
    if (arguments_.length > 1) {
      colorModeX = range1;
      colorModeY = range2 || range1;
      colorModeZ = range3 || range1;
      return ColourFunctions.colorModeA = range4 || range1;
    }
  };
  /*
  ...
  */
  ...
  modesFunction = (function() {
    var ALPHA_MASK, BLUE_MASK, GREEN_MASK, RED_MASK, applyMode, max, min;
  ...
  */
  ...
  window.blendColor = ColourFunctions.blendColor = function(c1, c2, mode) {
