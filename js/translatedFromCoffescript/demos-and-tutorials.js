...
createProgramLoader = function(eventRouter, texteditor, liveCodeLabCoreInstance) {
  ...
  ProgramLoader.program.roseDemo = "// 'B rose' by Guy John (@rumblesan)\n// Mozilla Festival 2012\n// adapted from 'A rose' by Lib4tech\n\ndoOnce -> frame = 0\nbackground red\nscale 1.5\nanimationStyle paintOver\nrotate frame/100\nfill 255-((frame/2)%255),0,0\nstroke 255-((frame/2)%255),0,0\nscale 1-((frame/2)%255) / 255\nbox".replace(/\u25B6/g, "\t");
  ProgramLoader.program.cheeseAndOlivesDemo = "// 'Cheese and olives' by\n// Davina Tirvengadum\n// Mozilla festival 2012\n\nbackground white\nscale .3\nmove 0,-1\nfill yellow\nstroke black\nrotate\nstrokeSize 3\nline 4\nbox\n\nrotate 2,3\nmove 0,3\nscale .3\nfill black\nstroke black\nball\n\nrotate 3\nmove 5\nscale 1\nfill green\nstroke green\nball\n\nrotate 1\nmove -3\nscale 1\nfill yellow\nstroke yellow\nball".replace(/\u25B6/g, "\t");
  ProgramLoader.program.simpleCubeDemo = "// there you go!\n// a simple cube!\n\nbackground yellow\nrotate 0,time/2000,time/2000\nbox".replace(/\u25B6/g, "\t");
  ProgramLoader.program.webgltwocubesDemo = "background 155,255,255\n2 times ->\n▶rotate 0, 1, time/2000\n▶box".replace(/\u25B6/g, "\t");
  ProgramLoader.program.cubesAndSpikes = "simpleGradient fuchsia,color(100,200,200),yellow\nscale 2.1\n5 times ->\n▶rotate 0,1,time/5000\n▶box 0.1,0.1,0.1\n▶move 0,0.1,0.1\n▶3 times ->\n▶▶rotate 0,1,1\n▶▶box 0.01,0.01,1".replace(/\u25B6/g, "\t");
  ProgramLoader.program.webglturbineDemo = "background 155,55,255\n70 times ->\n▶rotate time/100000,1,time/100000\n▶box".replace(/\u25B6/g, "\t");
  ProgramLoader.program.webglzfightartDemo = "// Explore the artifacts\n// of your GPU!\n// Go Z-fighting, go!\nscale 5\nrotate\nfill red\nbox\nrotate 0.000001\nfill yellow\nbox".replace(/\u25B6/g, "\t");
  ProgramLoader.program.littleSpiralOfCubes = "background orange\nscale 0.1\n10 times ->\n▶rotate 0,1,time/1000\n▶move 1,1,1\n▶box".replace(/\u25B6/g, "\t");
  ProgramLoader.program.tentacleDemo = "background 155,255,155\nscale 0.15\n3 times ->\n▶rotate 0,1,1\n▶10 times ->\n▶▶rotate 0,1,time/1000\n▶▶scale 0.9\n▶▶move 1,1,1\n▶▶box".replace(/\u25B6/g, "\t");
  ProgramLoader.program.lampDemo = "animationStyle motionBlur\nsimpleGradient red,yellow,color(255,0,255)\n//animationStyle paintOver\nscale 2\nrotate time/4000, time/4000,  time/4000\n90 times ->\n▶rotate time/200000, time/200000,  time/200000\n▶line\n▶move 0.5,0,0\n▶line\n▶move -0.5,0,0\n▶line\n▶line".replace(/\u25B6/g, "\t");
  ProgramLoader.program.trillionfeathersDemo = "animationStyle paintOver\nmove 2,0,0\nscale 2\nrotate\n20 times ->\n▶rotate\n▶move 0.25,0,0\n▶line\n▶move -0.5,0,0\n▶line".replace(/\u25B6/g, "\t");
  ProgramLoader.program.monsterblobDemo = "ballDetail 6\nanimationStyle motionBlur\nrotate time/5000\nsimpleGradient fuchsia,aqua,yellow\n5 times ->\n▶rotate 0,1,time/5000\n▶move 0.2,0,0\n▶3 times ->\n▶▶rotate 1\n▶▶ball -1".replace(/\u25B6/g, "\t");
  ProgramLoader.program.industrialMusicDemo = "bpm 88\nplay 'alienBeep'  ,'zzxz zzzz zzxz zzzz'\nplay 'beepC'  ,'zxzz zzzz xzzx xxxz'\nplay 'beepA'  ,'zzxz zzzz zzxz zzzz'\nplay 'lowFlash'  ,'zzxz zzzz zzzz zzzz'\nplay 'beepB'  ,'xzzx zzzz zxzz zxzz'\nplay 'voltage'  ,'xzxz zxzz xzxx xzxx'\nplay 'tranceKick'  ,'zxzx zzzx xzzz zzxx'".replace(/\u25B6/g, "\t");
