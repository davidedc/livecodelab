...
class MathFunctions
  ...
  addToScope: (scope) ->
    scope.addFunction('abs',     @abs)
    scope.addFunction('ceil',    @ceil)
    scope.addFunction('exp',     @exp)
    scope.addFunction('floor',   @floor)
    scope.addFunction('int',     @int)

    scope.addFunction('log',     @log)
    scope.addFunction('max',     @max)
    scope.addFunction('min',     @min)
    scope.addFunction('pow',     @pow)
    scope.addFunction('round',   @round)
    scope.addFunction('sqrt',    @sqrt)
    scope.addFunction('acos',    @acos)
    scope.addFunction('asin',    @asin)
    scope.addFunction('atan',    @atan)
    scope.addFunction('atan2',   @atan2)
    scope.addFunction('cos',     @cos)
    scope.addFunction('sin',     @sin)
    scope.addFunction('tan',     @tan)
