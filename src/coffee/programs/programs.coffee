...
programs.demos.twocubes = require('../../programs/demos/twocubes')
programs.demos.turbine = require('../../programs/demos/turbine')
programs.demos.lava = require('../../programs/demos/lava')
programs.demos.zfight = require('../../programs/demos/zfight')
programs.demos.aknot = require('../../programs/demos/aknot')
programs.demos.zigzag = require('../../programs/demos/zigzag')
programs.demos.shards = require('../../programs/demos/shards')
